...
const createPopUpFilmCardTemplate = () => {
  return (`
...
render(siteMainElement, createFilmListContainer(), `beforeend`);

const filmList = siteMainElement.querySelector(`.films-list`);
const filmListContainer = filmList.querySelector(`.films-list__container`);
const filmListExtraTemplate = siteMainElement.querySelector(`.films`).querySelectorAll(`.films-list--extra`);

new Array(FILM_LIST_COUNT).fill(``).forEach(() => render(filmListContainer, createFilmCardElement(), `beforeend`));
...
render(siteMainElement, createPopUpFilmCardTemplate(), `beforeend`);
